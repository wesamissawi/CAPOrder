...
contextBridge.exposeInMainWorld('api', {
  ...
  importCloverCsv: (payload) => ipcRenderer.invoke('clover:import-csv', payload),
  ...
  getRecentArchivedOrders: (limit) => ipcRenderer.invoke('orders-archive:recent', limit),
  ...
  resolveCapLines: (payload) => ipcRenderer.invoke('rules:resolve-lines', payload),
